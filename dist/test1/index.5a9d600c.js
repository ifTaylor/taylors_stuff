...
function scrollActive() {
    ...
    sections.forEach((current)=>{
        ...
        if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) document.querySelector(".nav__menu a[href*=" + sectionId + "]").classList.add("active");
        else document.querySelector(".nav__menu a[href*=" + sectionId + "]").classList.remove("active");
    });
}
...
//# sourceMappingURL=index.5a9d600c.js.map
